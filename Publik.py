...
Bots=[mid]
Creator= "u78643d09e42a36836a17cc918963a8b7" #bukan mid bot nya ya tapi mid si pembuat bot
admin= "u78643d09e42a36836a17cc918963a8b7" #yang ini samakan aja kayak mid creator
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like By :『TΣΔM SLΔCҜβΩT』 : 『 line.me/ti/p/~fuck.you__』",    
    "commentOn":True,
    "commentBlack":{},
    "blacklist":{},
    "wblacklist":False,
          ...
          if wait["autoCancel"]["on"] == True:
            if len(G.members) <= wait["autoCancel"]["members"]:
             ...
             #for i in gid:   
              ...
              hanna.contentMetadata={'mid':'u78643d09e42a36836a17cc918963a8b7'}
              cl.sendMessage(hanna)
...
#--------------------------------------------------------
                ...
                cl.sendText(msg.to,md + "TΣΔM SLΔCҜβΩT")
#--------------------------------------------------------
