...
#line = LINE()
line = LINE("EsuwILvxzOz2YkEcHDp7.Egq9cEqQnOnQf8YrIwoOTW.09w0ft50304IvpWvyvpDmP1eV9EC4Fu6q6GCCDWxUYA=")
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in Owner:
                        ...
                        settings["inviteprotect"] = False
                        settings["cancelprotect"] = False
                        line.sendMessage(msg.to,"➲ All Protect Set To Off")
                    else:
                        line.sendMessage(msg.to,"Just for Owner")
#--------------------------------
...
#==============================================================================#   
                ...
                ginvited = line.ginvited
                if ginvited != [] and ginvited != None:
                    for gid in ginvited:
                        line.rejectGroupInvitation(gid)
                        line.sendMessage(to, "Berhasil tolak sebanyak {} undangan".format(str(len(ginvited))))
                else:
                    line.sendMessage(to, "Tidak ada undangan yang tertunda")
                ...
                line.sendMessage(to, "Goblok cek sendiri di tanggal jangan manja")
        ...
        if op.type == 11:
            if op.param2 not in Owner:
                if op.param2 in admin and Bots and Owner:
                    ...
                    line.sendMessage(op.param1,"Qr under protect")
            else:
