# -*- coding: utf-8 -*- 
from LineKhie.linepy import *
from LineKhie.akad.ttypes import Message
from LineKhie.akad.ttypes import ContentType as Type
from LineKhie.akad.ttypes import ChatRoomAnnouncementContents
from LineKhie.akad.ttypes import ChatRoomAnnouncement
...
cl= LINE('EsiA0MssNnJum7Uoj0wc.z/X9R+nqYhUavsgL+iTJNa.LifUh0OQNsi4o1uUTbHGuYdZF/C/pYnrQtkEqihtWII=')
cl.log("Auth Token : " + str(cl.authToken))
channelToken = cl.getChannelResult()
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LINE ('Esnn4OR0jmWPVJ9DXR1d./v9XdUaS8nNNrJEgreBOFq.ncFKvE30iGLEE0RRfI02aRjE1d9OiZX8gID/vR5m91s=')
ki.log("Auth Token : " + str(ki.authToken))
channelToken = ki.getChannelResult()
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LINE ('EsRCZJqQ5p8776Di3Pc7.Rkvuy8qJW2mGeLMbsgKDPW.bQUJsvOiHmwIqJCu9DBweGZciZZTILmRCPx+CreIap0=')
...
oepoll1 = OEPoll(ki)
oepoll2 = OEPoll(kk)
creator = ["u67ec7daff350c87b805521a5fc8b639c"]
owner = ["u67ec7daff350c87b805521a5fc8b639c"]
admin = ["u67ec7daff350c87b805521a5fc8b639c"]
staff = ["u67ec7daff350c87b805521a5fc8b639c"]
...
wait = {
    ...
    "comment":"ᴀᴜᴛᴏ ʟɪᴋᴇ ʙʏ....[ ᴄxʙ ᴛᴇᴀᴍ ʙᴏᴛ ] \n♱ APK ALIANSI ♱",
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendText(msg.to, "◈╾ See you next time againt... "+str(G.name))
                                kk.sendText(msg.to, "◈╾ See you next time againt... "+str(G.name))
...
#===========Protection============#
                        ...
                        elif 'Protect|cancel ' in msg.text:
                           if msg._from in admin:
